...
export const env: AppEnv = {
  ...
  scope: (import.meta.env.VITE_ITWIN_SCOPE as string | undefined) ?? "itwin-platform",
  authority: (import.meta.env.VITE_ITWIN_AUTHORITY as string | undefined) ?? "https://ims.bentley.com",
  ...
  marketingBaseUrl: (import.meta.env.VITE_MARKETING_BASE_URL as string | undefined) ?? "/",
};
